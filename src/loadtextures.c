...
/*   Updated: 2019/10/09 17:17:57 by dtoy             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		loadtexturepics(t_doom *doom, t_pic *pic)
{
	...
	//pic[0].img = ft_memalloc(sizeof(t_img) * 1);
	surface = IMG_Load("textures/pic/pepe.png");
	pic[0].img.data = (int*)surface->pixels;
