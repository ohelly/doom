...
void		mouse_press_left_two_p_2(t_doom *doom, int x, int y)
{
...
void		mouse_press_left_two(t_doom *doom, int x, int y)
{
	...
	else if ((x >= 950 && x <= 1000 && y >= 310 && y <= 360) ||
	(x >= 1200 && x <= 1250 && y >= 310 && y <= 360))
		sel_txtc(x, y, doom->sects);
	else if ((x >= 950 && x <= 1000 && y >= 210 && y <= 260) ||
	(x >= 1200 && x <= 1250 && y >= 210 && y <= 260))
		sel_txtf(x, y, doom->sects);
	else
		mouse_press_left_two_p_2(doom, x, y);
}
...
void		mouse_press_left_thr(t_doom *doom, int x, int y)
{
	...
	else if ((x >= 950 && x <= 1000 && y >= 160 && y <= 210) ||
	(x >= 1200 && x <= 1250 && y >= 160 && y <= 210))
		sel_txt_spr(x, y, doom->aspr);
	else if ((x >= 950 && x <= 1000 && y >= 60 && y <= 110) ||
	(x >= 1200 && x <= 1250 && y >= 60 && y <= 110))
		sel_txt_obj(x, y, doom->obj);
	else if (x >= 1000 && x <= 1200 && y >= 260 && y <= 310)
		set_end_player(doom);
