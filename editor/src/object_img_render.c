...
/*   Updated: 2019/10/29 02:50:14 by ohelly           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	render_player_settings(t_txt *txt, t_player *player, t_sdl *sdl)
{
	...
	render_img(txt->huds[22], sdl->rend, (t_scale){ {1000, 415 }, 200, 37 });
}
